...
if (isset($_POST['submitPin'])) {
    ...
    if ($pin !== $pincode) {
        $reg_user->redirect("dashboard?pinerror");
    } else{
...
<div id="cot" style="display: none;">
    <ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
        <a role="tab" class="nav-link active" id="tab-0" data-toggle="tab" href="#tab-content-0">
            <span><i class='fas fa-money-check-alt' style='font-size:24px;color:orange'></i> Personal Identification Number (PIN)</span>
        </a>
    </li> 
</ul>                   
...
<div class="tab-content">
    <div class="form-desc" style="color:#05194B; text-align:justify;">
       Dear <strong style="color:brown;"><?php echo $row['firstname']." ". $row['lastname']; ?></strong>, kindly note that you are making a wire transfer of  
       <strong style="color:brown;"><?php echo $row['currency']; ?> <?php echo number_format($_SESSION['amt'],2); ?></strong>
   ...
   <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
    <div class="main-card mb-3 card">
        ...
        <br>
         ...
         <div class="position-relative form-group"><label for="exampleAddress" class="">Enter Pin Code Here </label>
            <input name="pin"  style="height:80px;"  type="text" class="form-control" required=""></div>
            ...
            <input type="hidden" name="pincode" value="<?php echo $_SESSION['pin']; ?>"/>

            <button  id="submitButton" type="submit" name="submitPin" class="mt-2 btn btn-primary">
