...
$db = mysqli_connect("localhost","root","","union") or die("Some error occurred during connection " . mysqli_error($db));  
...
while($row = mysqli_fetch_array($query))
{
     $email = $row['email'];
      ...
      $status = 'Succesful';
       ...
       $sql = "UPDATE account SET t_bal = '".$diffii."', a_bal = '".$difii."' WHERE acc_no = '".$uname."' "; 
        ...
        echo "<script type='text/javascript'>alert('Account Credit Failed');</script>";
         }else{
            echo "<script type='text/javascript'>alert('Account Credited Succesfully');</script>";
    ...
    <div class="page-wrapper bg-dark p-t-100 p-b-50">
        <div class="wrapper wrapper--w900">
            <div class="card card-6">
                <div class="card-heading">
                    <h2 class="title">Credit Account</h2>
                </div>
                <div class="card-body">
                    <form method="POST">
                        <div class="form-row">
        ...
        ?>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-6" type="number" name="amount" placeholder="3000000">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="input-group">
                                    <input class="input--style-6" type="submit" name="submit">
                                </div>
                        </div>
                    </form>
                </div>
