...
$query = "SELECT * FROM admin WHERE email='$email' and password='$upass'";
...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
    <head>
        ...
        <title><?php echo $sitename; ?> | Admin Sign In</title>
        ...
        <link href="css/style.css?version1" rel="stylesheet">
    ...
    <body id="skin-blur-window">
        ...
        <section id="login" align="center">
            <header><!-- <br><br><br><br> -->
                ...
                <br> -->
                <h3>Enter your login detains to access Admin Page</h3>
            </header>
