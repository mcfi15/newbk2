                            ...
                            <table width='100%' border='0' cellspacing='0' cellpadding='0' align='center' valign='top'>
                              ...
                              <tr>
                                <td valign='top' align='center'>
                                  <div class='contentEditableContainer contentTextEditable'>
                                    <div class='contentEditable' >
                                      <h3><span style='color:#2196F3;'>Royal Bank Finance</span> Account Details</h3>
									 ...
									 <div class='contentEditable' ><br>
                                      <p style='font-weight:bold;font-size:13px;line-height: 30px; color:red;'>Please, note that your Internet Banking is automatically activated and you will need a commbination of your account number and password to access your online banking at $siteurl</p>
                                    </div>
                                  </div>
                                </td>
                              </tr>
                              ...
                              <tr>
                                <td valign='top' align='center'>
                                  <div class='contentEditableContainer contentTextEditable'>
                                    <div class='contentEditable' >
                                      <p style=' font-weight:bold;font-size:13px;line-height: 30px;'>Royal Bank Finance</p>
                                    </div>
                                  </div>
                                  <div class='contentEditableContainer contentTextEditable'>
                                    <div class='contentEditable' >
                                  ...
                                  <div class='contentEditableContainer contentTextEditable'>
                                    <div class='contentEditable' >
                                      <a target='_blank' href='' style='line-height: 20px;color:#A8B0B6; font-size:13px;'>$siteemail</a>
                                    </div>
                                    </div>
									<div class='contentEditableContainer contentTextEditable'>
									<div class='contentEditable' >
                                      <a target='_blank' href='$siteurl' style='line-height: 20px;color:#A8B0B6; font-size:13px;'>$siteurl</a>
                                    </div>
                                  </div>
                                  <div class='contentEditableContainer contentTextEditable'>
...
";
			...
			send_mail($email,$messag,$subject);	
					 ...
					 header("Location: pending_accounts?approved");
			}
			else {
				
					  header("Location: pending_accounts?errora");
			}
...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
    <head>
        ...
        <title><?php echo $sitename; ?> | Admin - Approve Account</title>
