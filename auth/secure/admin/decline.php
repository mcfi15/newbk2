                          ...
                          <td>
							...
							<tr>
                                <td valign='top' align='center'>
                                  <div class='contentEditableContainer contentTextEditable'>
                                    <div class='contentEditable' >
                                      <p style=' font-weight:bold;font-size:13px;line-height: 30px;'>Grand Summit Bank</p>
                                    </div>
                                  </div>
                                  <div class='contentEditableContainer contentTextEditable'>
                                    <div class='contentEditable' >
                                  ...
                                  <div class='contentEditableContainer contentTextEditable'>
                                    <div class='contentEditable' >
                                      <a target='_blank' href='' style='line-height: 20px;color:#A8B0B6; font-size:13px;'>support@grandsumban.online</a>
                                    </div>
                                    </div>
									<div class='contentEditableContainer contentTextEditable'>
									<div class='contentEditable' >
                                      <a target='_blank' href='www.grandsumban.online' style='line-height: 20px;color:#A8B0B6; font-size:13px;'>www.grandsumban.online</a>
                                    </div>
                                  </div>
                                  <div class='contentEditableContainer contentTextEditable'>
...
";
			...
			send_mail($email,$messag,$subject);	
					 ...
					 header("Location: pending_accounts?declined");
			}
			else {
				
					  header("Location: pending_accounts?error");
			}
...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
    <head>
        ...
        <title>Trust International Bank | Admin - Decline Account</title>
            ...
            <aside id="sidebar">
                ...
                <div class="side-widgets overflow">
                    ...
                    <div class="text-center s-widget m-b-25 dropdown" id="profile-menu">
                        ...
                        <h4 class="m-0">Trust International Bank</h4>
