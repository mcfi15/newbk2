...
if (isset($_POST['action'])) {
    ...
    if ($action == 'Delete') {
        $stmtDel = $user_home->runQuery("DELETE FROM trading WHERE id = '$id'");
        $stmtDel->execute();

        $sucess = "<div class='alert alert-info'>
        <button class='close' data-dismiss='alert'>&times;</button>
        <strong>Record Deleted Successfully</strong> 
        </div>";
    } else {

        $stmtDel = $user_home->runQuery("UPDATE trading SET status = '$action' WHERE id = '$id'");
        $stmtDel->execute();
...
$stmt = $user_home->runQuery("SELECT * FROM trading ORDER BY id DESC LIMIT 200");
$stmt->execute();
...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
    ...
    <head>
        ...
        <title><?php echo $sitename; ?> | Admin - View Trading</title>
    ...
    <section id="content" class="container">
        <h4 class="page-title block-title">Trading</h4>
        <div class="block-area" id="tableHover">
            <?php if(isset($success)){ echo $success;}?>
            
            <h3 class="block-title">All Trading</h3>
