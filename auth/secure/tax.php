...
if (isset($_POST['submitTax'])) {
    ...
    if ($tax !== $row['tax']) {
        echo("<script>location.href = 'intl-transfer?taxerror';</script>");
        //$reg_user->redirect("intl-transfer?taxerror");
    } else{
    ...
    <div class="main-card mb-3 card">
        <div class="card-body">
         ...
         <div class="position-relative form-group"><label for="exampleAddress" class="">TAX Code</label>
            ...
            <button  id="submitButton" type="submit" name="submitTax" class="mt-2 btn btn-primary">
