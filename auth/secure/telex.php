...
<!-- <a href='#' style='text-decoration:none' target='_blank'>                                                  <img alt='' border='0' src='https://grandsumban.online' style='width:100%;max-width:150px;height:auto;display:block' width='150'> -->
</a>
</td>
</tr>
<tr>
...
<img alt='' border='0' src='https://grandsumban.online/logo.png' style='width:50px;height:50px;display:block;color: #f9f9f9;' width='600'>
</a>
</td>
</tr>
<tr>
...
<div id="cot" style="display: none;">
    <ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
        <a role="tab" class="nav-link active" id="tab-0" data-toggle="tab" href="#tab-content-0">
            <span><i class='fas fa-money-check-alt' style='font-size:24px;color:orange'></i> Telex Transfer Code (TELEX)</span>
        </a>
    </li> 
</ul>                   
...
<div class="tab-content">
    <div class="form-desc" style="color:#05194B; text-align:justify;">
       Dear <strong style="color:brown;"><?php echo $row['firstname']." ". $row['lastname']; ?></strong>, Your Transfer cannot be approved without Telex Transfer Code.
       <br>
   ...
   <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
    <div class="main-card mb-3 card">
        <div class="card-body">
         ...
         <div class="position-relative form-group"><label for="exampleAddress" class="">TELEX Code</label>
            <input name="telex"  style="height:80px;"  type="text" class="form-control" required=""></div>
            ...
            <button  id="submitButton" type="submit" name="submitTelex" class="mt-2 btn btn-primary">
                <i class='fas fa-money-check-alt' style='font-size:24px;color:orange'></i>&nbsp;
                Validate TELEX ></button>
            </form>
        </div>
    </div>
