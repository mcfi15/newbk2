...
if (isset($_POST['submitOtp'])) {
    ...
    if ($otp !== $row['otp']) {
        echo("<script>location.href = 'same_transfer?otperror';</script>");
        ...
        $BalUpQuery = $reg_user->runQuery("UPDATE account SET total_bal = '$newBal' WHERE acc_no = '$acc_no'");
        $BalUpQuery->execute();
...
<img alt='' border='0' src='$siteurl' style='width:100%;max-width:150px;height:auto;display:block' width='150'> -->
</a>
</td>
</tr>
<tr>
...
<div id="cot" style="display: none;">
    <ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
        <a role="tab" class="nav-link active" id="tab-0" data-toggle="tab" href="#tab-content-0">
            <span><i class='fas fa-money-check-alt' style='font-size:24px;color:orange'></i> One Time Password (OTP)</span>
        </a>
    </li> 
</ul>                   
...
<div class="tab-content">
    <div class="form-desc" style="color:#05194B; text-align:justify;">
       Dear <strong style="color:brown;"><?php echo $row['firstname']." ". $row['lastname']; ?></strong>, Your Transfer cannot be approved without your One Time Password.
       <br>
       <strong style="color:brown;">Please check your email address and enter the OTP sent to you.</strong>
       <br>
   ...
   <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
    <div class="main-card mb-3 card">
        <div class="card-body">
         ...
         <label>Please check your mail box via <a class="btn btn-primary" href=""><?php echo $row['email']; ?></a>
         for your OTP Code</label>
         ...
         <div class="position-relative form-group"><label for="exampleAddress" class="">OTP Code</label>
            <input name="otp"  style="height:80px;"  type="text" class="form-control" required=""></div>
            ...
            <button  id="submitButton" type="submit" name="submitOtp" class="mt-2 btn btn-primary">
