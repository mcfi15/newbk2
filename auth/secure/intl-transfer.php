...
if (isset($_POST['transfer'])) {
    ...
    $sacc_no = trim($_POST['saccno']);
    $sacc_no = strip_tags($sacc_no);
    $sacc_no = htmlspecialchars($sacc_no);

    $billing_switch = trim($_POST['billing_switch']);
    $billing_switch = strip_tags($billing_switch);
    $billing_switch = htmlspecialchars($billing_switch);
    ...
    if ($amt > $row['total_bal']) {
        ...
        $_SESSION['saccno'] = $sacc_no;
        $_SESSION['billing_switch'] = $billing_switch;
        $_SESSION['pin'] = $pin;
        $_SESSION['mode'] = "Wire";
        ...
        if($billing_switch == "No"){
            echo("<script>location.href = 'pin';</script>");
        }else{
            echo("<script>location.href = 'cot';</script>");
        }
                    ...
                    <div class="form-row">
                        <div class="col-md-6">
                            <div class="position-relative form-group"><label for="exampleEmail11" class="">Beneficiary Bank Name</label>
                                <input name="rbname" id="exampleEmail11" value="" placeholder="Receiver Bank Name" type="text" class="form-control" ></div>
                            </div>
                            <div class="col-md-6">
                                <div class="position-relative form-group"><label for="examplePassword11" class="">Beneficiary Account Number</label>
                                    <input name="accno" id="examplePassword11" value="" placeholder="Receiver Account Number" type="text"  class="form-control" ></div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-12">
                                    <div class="position-relative form-group"><label for="exampleEmail11" class="">Beneficiary FullName</label>
                                        <input name="bname" id="exampleEmail11" value="" placeholder="Receiver Fullname" type="text" class="form-control" ></div>
                                    </div>
                                    <!-- <div class="col-md-6">
                                        <div class="position-relative form-group"><label for="examplePassword11" class="">Beneficiary Email Address</label>
                                            <input name="bemailadd" id="examplePassword11" value="" placeholder="Receiver Email Address" type="email"  class="form-control" ></div>
                                        </div> -->
                                    </div>
                                    <br>
                                                 ...
                                                 <div class="form-row">
                                                    <div class="col-md-6">
                                                        <div class="position-relative form-group"><label for="examplePassword11" class="">Amount (<?php echo $row['currency']; ?>):</label>
                                                            <input name="amt" id="amt" value="" placeholder="Amount" type="number" step="0.01"  class="form-control" ></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <!-- <div class="position-relative form-group"><label for="exampleAddress" class="">Reason for Wire</label>
                                                        ...
                                                        <input name="billing_switch" type="hidden" readonly="true" value="<?php echo $row['billing_switch']; ?>"  id="saccno" class="form-control"  />
